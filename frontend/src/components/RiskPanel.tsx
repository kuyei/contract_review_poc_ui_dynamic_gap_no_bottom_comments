...
export function RiskPanel(props: {
  ...
  onLocateRisk: (opts: { riskId?: number | string; targetText?: string; anchorText?: string; evidenceText?: string; clauseUids?: string[] }) => void
  ...
  const locatePayloadOf = (r: RiskItem) => {
    ...
    return {
      riskId: r.risk_id,
      targetText: sanitizeAiTargetText(String((r.ai_rewrite || r.ai_apply || (r as any))?.target_text || '')),
                    ...
                    .map((r) => (
                      <div key={r.risk_id} className="riskCard">
                        ...
                        {(() => {
                          ...
                          const effectiveTarget = sanitizeAiTargetText(String((ai as any)?.target_text || ''))
                          ...
                          <button
                            ...
                            onClick={() => {
                              ...
                              if (ai) {
                                setEditorMode('ai')
                                setEditorTargetText(sanitizeAiTargetText(String((ai as any)?.target_text || '')))
